        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-[#0373BA] mb-2 text-5xl font-bold">Augmentation Projects</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-[#CCE7FA] mb-2">75</div>
              <p className="text-[#0373BA] mb-2 text-5xl font-bold">End-to-End Projects</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-[#CCE7FA] mb-2">87</div>
              <p className="text-[#0373BA] mb-2 text-5xl font-bold">Satisfied Customers</p>
            </div>
          </div>
        </div>
      </section>
