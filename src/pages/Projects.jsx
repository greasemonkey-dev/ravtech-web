        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-[#0373BA] mb-2 text-5xl font-bold">34</div>
              <p className="text-lg text-gray-700">Continuing Projects</p>
            </div>
            <div className="text-center">
              <div className="text-[#0373BA] mb-2 text-5xl font-bold">44</div>
              <p className="text-lg text-gray-700">Augmentation Projects</p>
            </div>
            <div className="text-center">
              <div className="text-[#0373BA] mb-2 text-5xl font-bold">75</div>
