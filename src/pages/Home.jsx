        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <div className="flex items-center justify-center gap-3 mb-5 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              ...
              <p className="bg-clip-text text-transparent text-lg font-normal tracking-wide sm:text-xl lg:text-2xl from-gray-700 via-[#0373BA] to-gray-700">END-TO-END IT PROJECTS_
