...
export default function HomePage() {
  ...
  "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69033bb7c3427caaeea09a3b/22c708602_QUALITEST-logo-6.png"];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-6">
            ...
            <div className="flex items-center justify-center gap-3 mb-5 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              ...
              <p className="bg-clip-text text-blue-950 text-lg font-normal tracking-wide sm:text-xl lg:text-2xl from-gray-700 via-[#0373BA] to-gray-700">END-TO-END IT PROJECTS_
