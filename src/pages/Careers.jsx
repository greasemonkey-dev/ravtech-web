    ...
    <div className="bg-white">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-[#0373BA] mb-12 would appreciate it if you could align the buttons so that they are aligned downwards equally on all three sides. Thank you.] w-24 h-1" />
